...
-- cheese
INSERT INTO mbti_questions (mbti_info_id, mbti_code, question_no, question, answer_a_option, answer_b_option) VALUES
(7, 'EI', 1, '치즈를 즐길 때 선호하는 상황은?', '조용한 환경에서 혼자', '사람들과 함께하는 즐거운 모임에서'),
(7, 'SN', 2, '치즈 선택 기준은?', '익숙하고 전통적인 치즈', '새롭고 독특한 종류의 치즈'),
(7, 'TF', 3, '치즈의 어떤 측면이 더 중요한가요?', '맛의 깊이와 복잡성', '치즈의 질감과 녹는 정도'),
(7, 'JP', 4, '치즈를 구매할 때 어떻게 결정하나요?', '미리 리뷰를 읽고 계획적으로 구매', '현장에서 직접 맛보고 결정'),
(7, 'SN', 5, '치즈를 고를 때 어떤 정보를 우선시 하나요?', '치즈의 유래와 제조 과정', '치즈의 맛과 텍스처 설명'),
(7, 'TF', 6, '치즈를 즐길 때 중요한 것은?', '치즈 자체의 맛과 품질', '치즈를 어떻게 활용할 수 있는지'),
(7, 'JP', 7, '치즈를 구매할 때의 스타일은?', '미리 리스트를 만들어 계획적으로 구매', '시식 후 기분에 따라 선택'),
(7, 'EI', 8, '치즈를 먹을 때 선호하는 분위기는?', '혼자서 조용히 즐기는', '사람들과 함께 즐기며 대화하는'),
(7, 'SN', 9, '새로운 치즈를 시도할 때 기준은?', '전문가의 추천이나 리뷰', '직관적으로 끌리는 맛이나 포장'),
(7, 'TF', 10, '치즈 감상 시 가장 중요하게 여기는 감각은?', '맛', '향기'),
(7, 'JP', 11, '치즈를 저장하는 방법은?', '정해진 방법과 조건에 따라 정리', '특별한 규칙 없이 보관'),
(7, 'EI', 12, '치즈를 고를 때 가장 영향을 주는 요소는?', '사회적 상황이나 타인의 의견', '개인적 취향과 선호도');
